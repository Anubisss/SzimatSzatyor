...
private:
    ...
    // address offsets for MOP, 17668
    static void FillHookEntry17668()
    {
        HookEntry hookEntry17668 = HookEntry(0x3988D7, 0x3965BB);
        _hookEntryMap[WOW_MOP_17668] = hookEntry17668;
    }
