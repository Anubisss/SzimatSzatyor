...
private:
    ...
    // address offset for WOD, 18397
    static void FillHookEntry18397()
    {
        HookEntry hookEntry18397 = HookEntry(0x296E23, 0x2944FC);
        _hookEntryMap[WOW_MOP_18397] = hookEntry18397;
    }
